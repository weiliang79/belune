...
INSERT INTO applications (project_id, name, slug, type, source_repo, source_image, dockerfile_path, build_type, cpu_limit, memory_limit, webhook_secret, git_credentials_encrypted, health_check_path, port)
...
UPDATE applications SET
    ...
    health_check_path = $13, port = $14, updated_at = NOW()
WHERE id = $1
RETURNING *;
