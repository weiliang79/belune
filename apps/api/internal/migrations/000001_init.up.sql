...
CREATE TABLE services (
    ...
    build_type VARCHAR(50) NOT NULL CHECK (build_type IN ('dockerfile', 'buildpacks', 'nixpacks', 'railpack', 'image')),
    build_type_override VARCHAR(50) CHECK (build_type_override IN ('dockerfile', 'buildpacks', 'nixpacks', 'railpack', 'image')),
