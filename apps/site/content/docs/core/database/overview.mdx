...
This is how any application or database in the **same project** reaches it, over the project's private network by container name; see [Architecture](/docs/core/architecture#networking).
...
<Callout type="info">
A schedule needs a project [backup destination](/docs/core/project/backup-destinations) to be configured first.
</Callout>
