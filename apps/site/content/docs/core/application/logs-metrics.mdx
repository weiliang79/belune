...
A build's output lives on the **Deployments** tab instead — each deployment keeps its own log, streamed live while building and browsable afterward. See [Deployments](/docs/core/application/deployments).
